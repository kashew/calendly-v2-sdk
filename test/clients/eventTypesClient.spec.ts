  ...
  describe('when response status is ok', () => {
    ...
    it('returns a promise that resolves', async () => {
      ...
      await expect(result).resolves.toEqual<EventType>({
        ...
        createdAt: eventTypeEntity.created_at,
        updatedAt: eventTypeEntity.updated_at,
      ...
      expect(result.collection).toEqual<EventType[]>([
        {
          ...
          createdAt: eventTypeEntity1.created_at,
          updatedAt: eventTypeEntity1.updated_at,
        ...
        },
        {
          ...
          createdAt: eventTypeEntity2.created_at,
          updatedAt: eventTypeEntity2.updated_at,
        ...
        },
        {
          ...
          createdAt: eventTypeEntity3.created_at,
          updatedAt: eventTypeEntity3.updated_at,
